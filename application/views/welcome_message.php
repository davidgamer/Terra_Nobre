...
<head>
    ...
    <link rel="stylesheet" href=<? echo base_url('includes/font-awesome/css/font-awesome.min.css')?> type="text/css">
	 <link rel="stylesheet" href=<? echo base_url('includes/css/style.css')?> type="text/css">
